...
class ContainerTest extends TestCase
{
    ...
    {
        $instance = $this->container->make(ClassWithParams::class, [
            'value' => 'custom value',
            'number' => 42
        ]);
    ...
    public function test_call_method_injection()
    {
        ...
        $result = $this->container->call([$instance, 'method'], [
            'param' => 'test'
        ]);
    ...
    {
        $result = $this->container->call(function(ConcreteClass $dep, $test) {
